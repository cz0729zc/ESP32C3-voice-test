...
void setup_scr_screen(lv_ui *ui)
{
    ...
    ui->screen_rlottie_1 = lv_rlottie_create_from_raw(ui->screen, 140, 140, (const void *)lottie_smile);
    lv_obj_set_pos(ui->screen_rlottie_1, 50, 50);
    lv_obj_set_size(ui->screen_rlottie_1, 140, 140);
