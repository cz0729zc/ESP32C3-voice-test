...
void setup_scr_screen_1(lv_ui *ui)
{
    ...
    lv_obj_set_style_bg_color(ui->screen_1, lv_color_hex(0x050000), LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_grad_dir(ui->screen_1, LV_GRAD_DIR_NONE, LV_PART_MAIN|LV_STATE_DEFAULT);

    //Write codes screen_1_rlottie_1
    ui->screen_1_rlottie_1 = lv_rlottie_create_from_raw(ui->screen_1, 140, 140, (const void *)lottie_sad);
    lv_obj_set_pos(ui->screen_1_rlottie_1, 50, 50);
    lv_obj_set_size(ui->screen_1_rlottie_1, 140, 140);
